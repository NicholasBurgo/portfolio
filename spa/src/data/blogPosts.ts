export type BlogPost = {
  slug: string;          // used in the URL, e.g. "stock-prediction-project"
  title: string;
  subtitle?: string;
  date: string;          // ISO string or "MMM DD, YYYY"
  readingTime: string;   // e.g. "6 min read"
  tags: string[];        // ["AI", "Unity", "School"]
...
const blogPosts: BlogPost[] = [
  {
    slug: "stock-prediction-neural-network",
    title: "Building a Stock Prediction Neural Network as a Student",
    subtitle: "Learning Deep Learning Through Real-World Application",
    date: "2024-01-15",
    readingTime: "8 min read",
    tags: ["AI", "Machine Learning", "Python", "Neural Networks"],
    excerpt: "A deep dive into building my first neural network for stock price prediction, from data collection to model training and evaluation. Learn about the challenges and insights I gained as a CS student tackling real-world machine learning problems.",
    content: `# Building a Stock Prediction Neural Network as a Student
...
*Note: This project was for educational purposes only. Never use student projects for actual trading decisions.*`
  },
  {
    slug: "site-extractor-user-agent",
    title: "How I Built a Site Extractor That Acts Like a User Agent",
    subtitle: "Web Scraping with Respect and Intelligence",
    date: "2024-02-20",
    readingTime: "6 min read",
    tags: ["Web Scraping", "Python", "Automation", "Ethics"],
    excerpt: "Building a web scraper that respects robots.txt, mimics real browser behavior, and handles dynamic content. This post covers the technical challenges and ethical considerations of modern web scraping.",
    content: `# How I Built a Site Extractor That Acts Like a User Agent
...
*Remember: With great scraping power comes great responsibility. Always respect website owners and their terms of service.*`
  },
  {
    slug: "devlog-1-zombie-farm-unity",
    title: "Devlog #1: Zombie Farm-Style Mobile Game in Unity",
    subtitle: "Building My First Mobile Game from Scratch",
    date: "2024-03-10",
    readingTime: "10 min read",
    tags: ["Unity", "Game Development", "C#", "Mobile Games"],
    excerpt: "The first entry in my devlog series documenting the development of a mobile farming game with zombie elements. Learn about game design decisions, Unity architecture, and the challenges of mobile game development.",
    content: `# Devlog #1: Zombie Farm-Style Mobile Game in Unity
...
*Follow my progress on GitHub or Twitter. Feedback and suggestions are always welcome!*`
  }
];
